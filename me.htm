...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-1 pb-1 mb-1 d-flex">
          <img src="suriya.jpg" alt="User Image" style="height:30px;">
        <div class="info">
          <a href="https://www.facebook.com/photo?fbid=2673247696260057&set=a.1378851725699667" class="d-block">Suriya Phutduang</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="https://www.facebook.com/Nick.Godzilla" class="nav-link">
                  <i class="fab fa-facebook-f nav-icon"></i> 
                  <p>Facebook</p>
                </a>
              </li>   
              <li class="nav-item">
                <a href="https://www.youtube.com/channel/UC7RFNDhNZD4x_UvToRIRNmA" class="nav-link">
  ...
  <div class="content-wrapper">  
    ...
    <section class="content">
            ...
            <fieldset class="col-12 small-box" style="font-family:kanit;font-size:25px;"><legend><b>ชมรมคนชอบเข้าเว็ป</b></legend>
            <style>
            .bigcap{float:left;font-size:60px;line-height:0.5;margin-top:5px;margin-right:5px;margin-left:5px;color:#000088}
            </style>
            <p><span class="bigcap">ส</span><b>วัสดีครับท่านสมาชิกชมรมคนชอบเข้าเว็ป</b>
            ชมรมนี้ หมายถึง การดำเนินกิจกรรมภายในและภายนอกองค์กร 
            ...
            <p><span class="bigcap">ธ</span><b>รรมะกระตุกจิตกระซากใจ</b> ในระดับของประชาสังคม ตัวอย่างความรับผิดชอบต่อสังคมของกิจการ ได้แก่ 
            ...
            <p><span class="bigcap">ดั</span><b>งนั้น</b> การเป็นผู้สนับสนุนเว็บไซต์ด้านการศึกษาอย่างคุณNick
